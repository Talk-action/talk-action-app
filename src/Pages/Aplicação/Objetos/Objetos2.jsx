...
function Objetos2({ palavraProp }) { // Recebe a palavra "Homem" como padrão
    ...
    <div className={style.container}>
      ...
      <div className={style.principal}>
        ...
        <div className={`${style.containerResp} ${campoTexto === true ? style.none : style.containerResp}`}>
          ...
          <p className={style.resposta} onClick={() => handleLetra('B')}>B</p>
          <p className={style.resposta} onClick={() => handleLetra('A')}>A</p>
          <p className={style.resposta} onClick={() => handleLetra('L')}>L</p>
